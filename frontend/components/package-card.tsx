...
export function PackageCard({
  ...
  return (
    <article className="premium-card group flex h-full flex-col justify-between p-7 transition duration-300 hover:-translate-y-1 hover:shadow-[var(--shadow-medium)]">
      <div>
      ...
      <div className="mt-8 flex items-center justify-between gap-4">
        <span className="text-sm text-slate-600">{travelPackage.duration_days} days of guided planning</span>
        <Link
